(function () {
  ...
  var TRANSLATIONS = {
    en: {
      ...
      'optimizer.uploadScreenshot': 'Upload Screenshots',
      'optimizer.uploadScreenshotsAria': 'Upload one or more screenshots',
      ...
      'events.processingImages': 'Processing screenshot {current} of {total}...',
      'events.ocrBatchComplete': 'Processed {total} screenshot(s): {detected} skill detection(s).',
      'events.ocrBatchPartialFailure':
        'Processed {succeeded} of {total} screenshots; {failed} failed. {detected} skill detection(s) available.',
      'events.ocrBatchAllFailed': 'All {total} screenshots failed to process.',
    ...
    ja: {
      ...
      'optimizer.uploadScreenshot': 'スクリーンショットをアップロード',
      'optimizer.uploadScreenshotsAria': '1枚以上のスクリーンショットをアップロード',
      ...
      'events.processingImages': 'スクリーンショット {current} / {total} を処理中...',
      'events.ocrBatchComplete':
        '{total}枚のスクリーンショットを処理し、{detected}件のスキルを検出しました。',
      'events.ocrBatchPartialFailure':
        '{total}枚中{succeeded}枚を処理しました。{failed}枚は失敗し、{detected}件のスキルを確認できます。',
      'events.ocrBatchAllFailed': '{total}枚のスクリーンショットをすべて処理できませんでした。',
