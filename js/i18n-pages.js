(function () {
  ...
  // This file contains all page-specific translations for the Uma Tools site
  // It should be loaded after i18n-core.js

  if (!window.I18n) {
    console.error('i18n-pages.js requires i18n-core.js to be loaded first');
    return;
  }
  ...
  var PAGE_TRANSLATIONS = {
    en: {
      ...
      'deck.templatesSource': 'Based on beta.uma.moe 2026-05-11 MANT Class 6 statistics',
      'deck.templateUsage': '{0}% of MANT Class 6 decks',
    ...
    ja: {
      ...
      'deck.templatesSource': 'beta.uma.moe 2026-05-11 MANTクラス6統計に基づく',
      'deck.templateUsage': 'MANTクラス6デッキの{0}%が使用',
  ...
  // Add page translations to the global I18n object
  if (window.I18n && window.I18n.addTranslations) {
    window.I18n.addTranslations(PAGE_TRANSLATIONS);
  }
})();
